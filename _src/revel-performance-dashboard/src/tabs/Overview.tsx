      ...
      <section aria-label="Key metrics">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 stagger">
          <KpiCard
            ...
            tooltip="Source: Meta and Google Ads APIs, pulled nightly. Calculation: sum of media spend for the selected window. Excludes the 6% agency fee (that enters the MER only)."
          />
          <KpiCard
            label="Revenue"
          ...
          <KpiCard
            ...
            tooltip="Source: GA4 (revelsaunas.com.au property), filtered to Australian traffic only. Calculation: total sessions in the window."
          />
        ...
        <section className="dash-card p-5" aria-label="Gross profit vs budget">
          <div className="flex items-center gap-2 mb-3">
            ...
            <SourceLink
              ...
              title="Source: FY27 daily GP budget/forecast (Google Sheet, REVEL DATA tab)"
            />
          </div>
