...
const GAF_LOGO_URL =
  "https://cdn.shopify.com/s/files/1/1950/1891/files/GAFLogo-Primary-WhiteBG_51691f07-8b4f-4d1d-aefc-f2fc004eaa84.png?v=1775792576";
  ...
  return (
    <div className="flex min-h-screen" style={{ background: "var(--gaf-page-bg)", color: "var(--gaf-text-primary)" }}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        >
          <span>AFS Group · GAF Performance Dashboard</span>
